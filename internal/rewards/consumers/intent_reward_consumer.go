...
func NewIntentRewardConsumer(rewards rewardsdomain.RewardRepository, _ *messaging.Bus, log *slog.Logger) *IntentRewardConsumer {
	if log == nil {
		log = slog.Default()
	}
	return &IntentRewardConsumer{rewards: rewards, log: log}
}
