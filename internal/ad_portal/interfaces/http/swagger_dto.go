...
import adportalApp "skykin-platform/internal/ad_portal/application"
...
type RegisterResponse = adportalApp.RegisterResult

type LoginUserInfo = adportalApp.UserInfo

type AdPortalLoginResponse = adportalApp.LoginResult
